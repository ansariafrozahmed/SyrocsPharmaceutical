...
const ContactForm = () => {
  ...
  const handleContactSubmit = async (e) => {
    ...
    setSubmitting(true);
    try {
      const response = await fetch(`${ADMINURL}api/contact`, {
        method: "POST",
        headers: {
              ...
              <div class="mb-12 max-w-[570px] lg:mb-0">
                ...
                <div class="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div class="w-full">
                    ...
                    <p class="text-base text-body-color dark:text-dark-6">
                      info@syrocspharmaceuticals.com
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="relative p-8 bg-white rounded-lg shadow-lg dark:bg-dark-2 sm:p-12">
                <form onSubmit={handleContactSubmit}>
                  ...
                  <div>
                    <button
                      type="submit"
                      class="w-full border-gray-500 p-3 transition border shadow-lg rounded border-primary bg-primary hover:bg-opacity-90"
                    >
